...
const Navbar = () => {
    ...
    useEffect(() => { setCurrUrl({ currUrl: location.pathname }) }, [location])


    return (
        <nav className='sticky top-0 left-0 right-0 bg-white w-screen'>
            <div className="flex items-center justify-between">
                <div className="flex items-center justify-between w-full px-2 lg:px-5 xl:px-20 md:px-5 pt-1">
